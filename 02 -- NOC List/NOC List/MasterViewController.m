...
- (void)loadNocList
{
    ...
    {
        Agent *anItem = [Agent agentWithDictionary:aDict];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"AgentDetailCell" forIndexPath:indexPath];
...
//    Agent *anAgent = nil;
    ...
    Agent *anItem = [self.agents objectAtIndex:indexPath.row];
