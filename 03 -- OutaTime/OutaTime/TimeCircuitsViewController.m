...
- (void)viewDidLoad
{
    ...
    NSString *formattedDate = [formatTime stringFromDate:[NSDate date]]; // [NSDate date] gives you current date
...
- (void)destinationDateWasChosen:(NSDate *)destinationDate
{
    ...
    //
    self.destinationTimeLabel.text = [formatTime stringFromDate:destinationDate];
}
