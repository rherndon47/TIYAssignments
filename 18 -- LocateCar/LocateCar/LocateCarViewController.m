...
- (void)configureLocationManager
{
    ...
    {
        [self.markLocation setEnabled:NO];  // turning the button off
    }
}
...
- (void) locationManager:(CLLocationManager *)manager didChangeAuthorizationStatus:(CLAuthorizationStatus)status
{
    ...
    else
    {
        ...
        [self.markLocation setEnabled:YES];  // turning the button on
    }
}
...
- (void)locationManager:(CLLocationManager *)manager didUpdateLocations:(NSArray *)locations
{
    ...
    double lat = location.coordinate.latitude;      // get the current lat long
    double lng = location.coordinate.longitude;
    NSLog(@"lat %f lng %f", lat, lng);
    [self.markLocation setEnabled:YES];             // turn button on
